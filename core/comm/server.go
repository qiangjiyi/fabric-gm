...
type GRPCServer struct {
	...
	lock *sync.Mutex
	// Set of PEM-encoded sm2 certificate authorities used to populate
...
// AppendClientRootCAs appends PEM-encoded sm2 certificate authorities to
...
// RemoveClientRootCAs removes PEM-encoded sm2 certificate authorities from
// the list of authorities used to verify client certificates
