...
type SecureOptions struct {
	...
	// PEM-encoded sm2 public key to be used for TLS communication
	Certificate []byte
	// PEM-encoded private key to be used for TLS communication
	Key []byte
	// Set of PEM-encoded sm2 certificate authorities used by clients to
	// verify server certificates
	ServerRootCAs [][]byte
	// Set of PEM-encoded sm2 certificate authorities used by servers to
